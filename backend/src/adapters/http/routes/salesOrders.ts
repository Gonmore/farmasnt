    ...
    async (request, reply) => {
      ...
      return reply.send({
        ...
        lines: order.lines.map((l: any) => ({
          ...
          product: l.product,
          baseUnitAbbreviation: (l.product as any).baseUnitAbbreviation ?? 'u',
        })),
          ...
          return reply.send({
            items: reservations.map((r) => {
              ...
              return {
                ...
                baseUnitAbbreviation: balance?.product?.baseUnitAbbreviation ?? 'u',
            ...
            return reply.send({
              items: movements.map((m) => {
                ...
                return {
                  ...
                  baseUnitAbbreviation: m.product?.baseUnitAbbreviation ?? 'u',
          ...
          return reply.send({
            items: lines.map((line) => {
              ...
              return {
                ...
                baseUnitAbbreviation: line.product?.baseUnitAbbreviation ?? 'u',
                batchId: null,
                batchNumber: null,
                expiresAt: null,
                locationId: null,
